#############################################################################
# Makefile for building: buttonPush
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  buttonPush.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile buttonPush.pro
#############################################################################
...
Makefile: buttonPush.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/buttonPush1.0.0 || mkdir -p .tmp/buttonPush1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/buttonPush1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/buttonPush1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/buttonPush1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/buttonPush1.0.0/ && (cd `dirname .tmp/buttonPush1.0.0` && $(TAR) buttonPush1.0.0.tar buttonPush1.0.0 && $(COMPRESS) buttonPush1.0.0.tar) && $(MOVE) `dirname .tmp/buttonPush1.0.0`/buttonPush1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/buttonPush1.0.0
